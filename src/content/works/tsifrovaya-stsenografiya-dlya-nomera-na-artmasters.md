---
id: "work:tsifrovaya-stsenografiya-dlya-nomera-na-artmasters"
kind: work
title: "Цифровая сценография для номера на ArtMasters"
summary: "На финальном этапе компетенции «Дизайнер виртуальных миров» нужно было в коллаборации с другими участниками сделать визуальное решение для мультимедийного номера к 130-летию Сергея Есенина. Это была уже не абстрактная м…"
year: 2025
genres: ["xr","video","art"]
...
legacySource: "F:/Code/active/sverseq#published:tsifrovaya-stsenografiya-dlya-nomera-na-artmasters"
relations: [{"target":"work:otborochnaya-rabota-artmasters","type":"related","evidence":"editorial","confidence":0.8}]
---
## Задача
...
Если смотреть на эту историю целиком, то её входной точкой была [отборочная работа ArtMasters](/works/otborochnaya-rabota-artmasters/) с образом двери в желаемый мир. Там я только нащупывал возможность входа, а здесь уже проверял, как этот вход работает в реальном производственном и художественном контексте.

## Связи
- Клиент: ArtMasters
- Проект:
- Связанные кейсы: [Отборочная работа ArtMasters](/works/otborochnaya-rabota-artmasters/)
- Посты / материалы: 2025-09-13_Финал-ArtMasters-виртуальный-мир-Есенина
