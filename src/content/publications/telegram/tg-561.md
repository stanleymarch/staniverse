...
summary: "Принес две полезные ссылки про ИИ и бизнес. В отличие от бесконечных инфоцыганских \"применений нейросетей в бизнесе\" - это два материала от Google и Open AI. Первый - 601 реальный пример применения ИИ от разных компаний…"
