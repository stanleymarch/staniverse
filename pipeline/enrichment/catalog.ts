...
export const topicRules: Rule[] = [
  ...
  { label: "близость, отношения и компаньоны", patterns: [/ии[- ]?(?:вайфу|компаньон)/iu, /ai[- ]?(?:waifu|companion)/iu, /виртуальн(?:ый|ого|ым)\s+(?:партн[её]р|компаньон)/iu, /character\.ai/iu, /replika\b/iu, /sillytavern/iu, /эмоциональн(?:ый|ого|ым)\s+компаньон/iu] },
